...
export interface BeetsNftDescriptorInterface extends utils.Interface {
  functions: {
...
export interface BeetsNftDescriptor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BeetsNftDescriptorInterface;
