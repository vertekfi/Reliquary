...
export interface MultiplierRewarderInterface extends utils.Interface {
  functions: {
...
export interface MultiplierRewarder extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiplierRewarderInterface;
