...
export interface IReliquaryGamifiedInterface extends utils.Interface {
  functions: {
...
export interface IReliquaryGamified extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReliquaryGamifiedInterface;
