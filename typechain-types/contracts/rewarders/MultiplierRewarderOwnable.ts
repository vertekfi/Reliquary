...
export interface MultiplierRewarderOwnableInterface extends utils.Interface {
  functions: {
...
export interface MultiplierRewarderOwnable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiplierRewarderOwnableInterface;
