...
import type {
  IReliquary,
  IReliquaryInterface,
} from "../../../contracts/interfaces/IReliquary";
...
export class IReliquary__factory {
  static readonly abi = _abi;
  static createInterface(): IReliquaryInterface {
    return new utils.Interface(_abi) as IReliquaryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IReliquary {
    return new Contract(address, _abi, signerOrProvider) as IReliquary;
  }
}
